...
// WiFi credentials
/*
const char* ssid = "Samsung Galaxy S42 Pro";      // WiFi SSID - Replace your own
const char* password = "12345678";  // WiFi Password - Replace your own
*/
const char* ssid = "4G-WIFI";      // WiFi SSID
const char* password = "julianbauer";  // WiFi Password 

// Server details for sending GPS data
const char* serverUrl = "https://gps-server-6brc.onrender.com/gps";  // Server URL
const char* apiKey = "tQJxIjDs440Q";                                  //12 character API key for authentication
...
const unsigned long uploadInterval = 120000;  // Data sent every 10 seconds
...
void parseGPGGA(String gpgga) {
 ...
 if (tokenIndex > 1) {
   ...
   if (latestGPSRawData.satellites >= 4) {  // Ensure enough satellites are available 4 ist norm
     ...
     gpsDataValid = false;
     digitalWrite(gpsStatusLED, LOW);
     Serial.print((int)latestGPSRawData.satellites);
     Serial.println(" Satillites connected");
   }
 }
}
